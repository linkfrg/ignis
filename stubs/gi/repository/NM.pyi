...
def vpn_editor_plugin_load_from_file(plugin_name: str, check_service: str, check_owner: int, check_file: Callable[..., bool], *user_data: Any) -> VpnEditorPlugin: ...
...
class Connection(GObject.GInterface):
    ...
    def dump(self) -> None: ...
    def for_each_setting_value(self, func: Callable[..., None], *user_data: Any) -> None: ...
    def get_connection_type(self) -> str: ...
    def get_id(self) -> str: ...
...
class SecretAgentOld(GObject.Object, Gio.AsyncInitable, Gio.Initable):  # type: ignore
    ...
    def __init__(self, auto_register: bool = ...,
                 ...
                 dbus_connection: Gio.DBusConnection = ...,
                 identifier: str = ...): ...
    def delete_secrets(self, connection: Connection, callback: Callable[..., None], *user_data: Any) -> None: ...
    def destroy(self) -> None: ...
    def do_cancel_get_secrets(self, connection_path: str, setting_name: str) -> None: ...
    def do_delete_secrets(self, connection: Connection, connection_path: str, callback: Callable[..., None], *user_data: Any) -> None: ...
    def do_get_secrets(self, connection: Connection, connection_path: str, setting_name: str, hints: Sequence[str], flags: SecretAgentGetSecretsFlags, callback: Callable[..., None], *user_data: Any) -> None: ...
    def do_save_secrets(self, connection: Connection, connection_path: str, callback: Callable[..., None], *user_data: Any) -> None: ...
...
class Setting8021x(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, altsubject_matches: Sequence[str] = ...,
                 anonymous_identity: str = ...,
                 auth_timeout: int = ...,
                 ca_cert: GLib.Bytes = ...,
                 ca_cert_password: str = ...,
...
class SettingIPConfig(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, addresses: Sequence[IPAddress] = ...,
                 auto_route_ext_gw: Ternary = ...,
                 dad_timeout: int = ...,
                 dhcp_dscp: str = ...,
                 dhcp_hostname: str = ...,
...
class SettingMatch(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, driver: Sequence[str] = ...,
...
class SettingTCConfig(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, qdiscs: Sequence[TCQdisc] = ...,
                 tfilters: Sequence[TCTfilter] = ...): ...
...
class SettingVlan(Setting):
    ...
    class Props:
        ...
        name: str
    props: Props = ...
    def __init__(self, egress_priority_map: Sequence[str] = ...,
                 flags: VlanFlags = ...,
                 id: int = ...,
...
class VpnServicePluginClass(GObject.GPointer):
    ...
    connect_interactive: Callable[[VpnServicePlugin, Connection, GLib.Variant], bool] = ...
    padding: list[None] = ...
