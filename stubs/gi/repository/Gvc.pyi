...
class HeadsetPortChoice(GObject.GFlags):  # type: ignore
    HEADPHONES = 1
    HEADSET = 2
    MIC = 4
    NONE = 0

class MixerControlState(GObject.GEnum):  # type: ignore
    CLOSED = 0
    CONNECTING = 2
    FAILED = 3
    READY = 1

class MixerStreamState(GObject.GEnum):  # type: ignore
    IDLE = 2
    INVALID = 0
    RUNNING = 1
    SUSPENDED = 3

class MixerUIDeviceDirection(GObject.GEnum):  # type: ignore
    INPUT = 0
    OUTPUT = 1
